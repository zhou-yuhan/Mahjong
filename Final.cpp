...
//三色三同顺
bool Mixed_Triple_Chow(int x) {
    int num = x % 10;
    int k1 = allhandset.count(10 + num - 2);
    int k2 = allhandset.count(10 + num - 1);
    int k3 = allhandset.count(10 + num);
    int k4 = allhandset.count(10 + num + 1);
    int k5 = allhandset.count(10 + num + 2);
    int m1 = allhandset.count(30 + num - 2);
    int m2 = allhandset.count(30 + num - 1);
    int m3 = allhandset.count(30 + num);
    int m4 = allhandset.count(30 + num + 1);
    int m5 = allhandset.count(30 + num + 2);
    int n1 = allhandset.count(50 + num - 2);
    int n2 = allhandset.count(50 + num - 1);
    int n3 = allhandset.count(50 + num);
    int n4 = allhandset.count(50 + num + 1);
    int n5 = allhandset.count(50 + num + 2);
    if (k1 >= 0 && k2 >= 0 && k3 >= 0 && m1 >= 0 && m2 >= 0 && m3 >= 0 && n1 >= 0 && n2 >= 0 && n3 >= 0)
        return true;
    if (k4 >= 0 && k2 >= 0 && k3 >= 0 && m4 >= 0 && m2 >= 0 && m3 >= 0 && n4 >= 0 && n2 >= 0 && n3 >= 0)
        return true;
    if (k4 >= 0 && k5 >= 0 && k3 >= 0 && m4 >= 0 && m5 >= 0 && m3 >= 0 && n4 >= 0 && n5 >= 0 && n3 >= 0)
        return true;
    return false;
}
...
//花龙
bool Mixed_Straight(int x) {
    int numone = x % 10;
    int numten = x / 10;
    if (numone == 1 || numone == 2 || numone == 3) {
        if (numten == 1) {
            if (allhandset.count(11) > 0 && allhandset.count(12) && allhandset.count(13) && allhandset.count(34) && allhandset.count(35)
                && allhandset.count(36) && allhandset.count(57) && allhandset.count(58) && allhandset.count(59))
                return true;
            if (allhandset.count(11) > 0 && allhandset.count(12) && allhandset.count(13) && allhandset.count(54) && allhandset.count(55)
                && allhandset.count(56) && allhandset.count(37) && allhandset.count(38) && allhandset.count(39))
                return true;
        }
        if (numten == 3) {
            if (allhandset.count(31) > 0 && allhandset.count(32) && allhandset.count(33) && allhandset.count(54) && allhandset.count(55)
                && allhandset.count(56) && allhandset.count(17) && allhandset.count(18) && allhandset.count(19))
                return true;
            if (allhandset.count(31) > 0 && allhandset.count(32) && allhandset.count(33) && allhandset.count(14) && allhandset.count(15)
                && allhandset.count(16) && allhandset.count(57) && allhandset.count(58) && allhandset.count(59))
                return true;
        }
        if (numten == 5) {
            if (allhandset.count(51) > 0 && allhandset.count(52) && allhandset.count(53) && allhandset.count(34) && allhandset.count(35)
                && allhandset.count(36) && allhandset.count(17) && allhandset.count(18) && allhandset.count(19))
                return true;
            if (allhandset.count(51) > 0 && allhandset.count(52) && allhandset.count(53) && allhandset.count(14) && allhandset.count(15)
                && allhandset.count(16) && allhandset.count(37) && allhandset.count(38) && allhandset.count(39))
                return true;
        }
    }
    if (numone == 4 || numone == 5 || numone == 6) {
        if (numten == 1) {
            if (allhandset.count(31) > 0 && allhandset.count(32) && allhandset.count(33) && allhandset.count(14) && allhandset.count(15)
                && allhandset.count(16) && allhandset.count(57) && allhandset.count(58) && allhandset.count(59))
                return true;
...
//三色三节高
bool Mixed_Shifted_Pungs(int x) {
    int num = x % 10;
    int ten = x / 10;
    int k1 = allhandset.count(10 + num - 2);
    int k2 = allhandset.count(10 + num - 1);
...
//一色三步高
bool Pure_Shifted_Chows(int x) {
    set<int> PengMid;
    for (auto i = pack.begin(); i != pack.end(); ++i)
        if (i->first == "PENG")
            PengMid.insert(NewNum((i->second).first));
    int x1 = allhandset.count(x - 4);
    int x2 = allhandset.count(x - 3);
    int x3 = allhandset.count(x - 2);
    int x4 = allhandset.count(x - 1);
    int x5 = allhandset.count(x);
    int x6 = allhandset.count(x + 1);
    int x7 = allhandset.count(x + 2);
    int x8 = allhandset.count(x + 3);
    int x9 = allhandset.count(x + 4);
    if (x1 > 0 && x2 > 1 && x3 > 2 && x4 > 1 && x5 > 0 
        && PengMid.count(x2) == 0 && PengMid.count(x3) == 0 && PengMid.count(x4) == 0)
        return true;
    if (x2 > 0 && x3 > 1 && x4 > 2 && x5 > 1 && x6 > 0
        && PengMid.count(x3) == 0 && PengMid.count(x4) == 0 && PengMid.count(x5) == 0)
        return true;
    if (x3 > 0 && x4 > 1 && x5 > 2 && x6 > 1 && x7 > 0
        && PengMid.count(x4) == 0 && PengMid.count(x5) == 0 && PengMid.count(x6) == 0)
        return true;
    if (x4 > 0 && x5 > 1 && x6 > 2 && x7 > 1 && x8 > 0
        && PengMid.count(x5) == 0 && PengMid.count(x6) == 0 && PengMid.count(x7) == 0)
        return true;
    if (x5 > 0 && x6 > 1 && x7 > 2 && x8 > 1 && x9 > 0
        && PengMid.count(x6) == 0 && PengMid.count(x7) == 0 && PengMid.count(x8) == 0)
        return true;
    return false;
}

//老少副
bool Two_Terminal_Chows(int x) {
    int num = x % 10;
    if (num >= 4 && num <= 6)
        return false;
    set<int> CHIMid;
    for (auto i = pack.begin(); i != pack.end(); ++i)
        if (i->first == "CHI")
            CHIMid.insert(NewNum((i->second).first));
    int ten = x / 10;
    if (handset.count(ten + 1) > 0 && handset.count(ten + 2) > 0 && handset.count(ten + 3) > 0 && CHIMid.count(ten + 8) > 0)
        return true;
    if (handset.count(ten + 7) > 0 && handset.count(ten + 8) > 0 && handset.count(ten + 9) > 0 && CHIMid.count(ten + 2) > 0)
        return true;
    if (CHIMid.count(ten + 2) > 0 && CHIMid.count(ten + 8) > 0)
        return true;
    if (handset.count(ten + 1) > 0 && handset.count(ten + 2) > 0 && handset.count(ten + 3) > 0
        && handset.count(ten + 7) > 0 && handset.count(ten + 8) > 0 && handset.count(ten + 9) > 0)
        return true;
    return false;
}
...
int Marking(string card) {
    ...
    if (x < 60) {//如果是数字牌
        ...
        for (int i = 10; i <= 50; i += 20)
            if (handset.count(i + Num1to9) > 0 && i + Num1to9 != x) {
                ...
                if (handset.count(i + Num1to9 - 1) > 0 && handset.count(x - 1) > 0)//相邻左牌也存在同数字不同色时，权重增加
                    mark += MyMin(handset.count(i + Num1to9 - 1), handset.count(x - 1)) * params.snumdcolor * 2;
                if (handset.count(i + Num1to9 + 2) > 0 && handset.count(x + 2) > 0)//相隔右牌也存在同数字不同色时，权重增加，但是要比相邻时低一些
                    mark += MyMin(handset.count(i + Num1to9 + 2), handset.count(x + 2)) * params.snumdcolor;
                if (handset.count(i + Num1to9 - 2) > 0 && handset.count(x - 2) > 0)//相隔左牌也存在同数字不同色时，权重增加，但是要比相邻时低一些
                    mark += MyMin(handset.count(i + Num1to9 - 2), handset.count(x - 2)) * params.snumdcolor;
            }
        if (Two_Terminal_Chows(x))//老少副
            mark += params.BigFan;
        ...
        if (Pure_Straight(x))//清龙
            mark += params.BigFan;
        if (Mixed_Straight(x))//花龙
            mark += params.BigFan;
        if (Quadruple_Chow(x))//一色四同顺
            mark += params.BigFan;
        if (Pure_Triple_Chow(x))//一色三同顺
            mark += params.BigFan;
        if (Mixed_Triple_Chow(x))//三色三同顺
            mark += params.BigFan;
        if (Mixed_Shifted_Pungs(x))//三色三节高 
            mark += params.BigFan;
        if (Pure_Shifted_Chows(x))//一色三步高
            mark += params.BigFan;
    }
...
bool CanBUGANG(string card, int supplier = myPlayerID) {
    if (TileLeft[myPlayerID] == 0 || TileLeft[NextID(myPlayerID) == 0]) 
        return false;
    for (auto i = pack.begin(); i != pack.end(); ++i) {
